package com.syhd.user.aop;

import java.lang.reflect.Method;


import com.syhd.user.annotation.MasterConnection;
import com.syhd.user.annotation.SlaveConnection;
import com.syhd.user.config.DbContextHolder;
...
public class DataSourceAspect {
	...
	@Before("execution(* com.*.*.service.*.*(..))")//前置通知时切换数据库连接

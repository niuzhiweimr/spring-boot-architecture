...
public final class DateUtil {
    ...
    //传入一个时间戳 转换为int
    public static int getTimeStamp(Timestamp time) {
        Long longTime = time.getTime() / 1000;
        return Integer.valueOf(longTime.toString());
    }

    //传入一个时间戳 转换为long
    public static long getTimeStame(Timestamp time) {
        return time.getTime();
    }

    //传入一个时间戳转换为 年月日 时分秒
    public static String TimeStampFormatSecond(Timestamp time) {
        DateFormat sdf = new SimpleDateFormat(DateUtil.DEFAULT_DATETIME_PATTERN);
        return sdf.format(time);
    }

    //传入一个时间戳转换为 年月日
    public static String TimeStampFormatDay(Timestamp time) {
        DateFormat sdf = new SimpleDateFormat(DateUtil.DEFAULT_DATE_PATTERN);
        return sdf.format(time);
    }

    //传入一个时间戳转换为 年月
    public static String TimeStampFormatMonths(Timestamp time) {
        DateFormat sdf = new SimpleDateFormat("YYYY-MM");
        return sdf.format(time);
    }

    //传入一个时间戳转换为 年
    public static String TimeStampFormatYear(Timestamp time) {
    ...
    //获取 延时 时间戳
    public static Timestamp currTimeStamp(Long delayTime) {
        return new Timestamp(new Date().getTime());
    }
    ...
    public static void main(String[] args) {
        System.out.println(DateUtil.currTimeStamp());
        System.out.println(getTimeStamp(DateUtil.currTimeStamp()));
        System.out.println(DateUtil.TimeStampFormatSecond(DateUtil.currTimeStamp()));
        System.out.println(DateUtil.TimeStampFormatDay(DateUtil.currTimeStamp()));
        System.out.println(DateUtil.TimeStampFormatMonths(DateUtil.currTimeStamp()));
        System.out.println(DateUtil.TimeStampFormatYear(DateUtil.currTimeStamp()));
    }
